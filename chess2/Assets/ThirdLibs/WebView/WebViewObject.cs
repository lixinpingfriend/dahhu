...
//    }
        ...
        Callback started = null)
    {
        ...
        if (enableWKWebView) {
            //使用腾讯X5内核
            webView = new AndroidJavaObject("net.gree.unitywebview.CX5WebViewPlugin");
        }  else {
...
// #endif
    ...
    public void SetMargins(Camera camera, GameObject leftTop, GameObject rightBottom)
    {
        int[] mWebViewRect = new int[4];
            ...
            mWebViewRect[0] = UniWebViewEx.ConvertPixelToPoint(Screen.height - (int)ltSp.y, false);
            mWebViewRect[1] = UniWebViewEx.ConvertPixelToPoint((int)ltSp.x, true);
            mWebViewRect[2] = UniWebViewEx.ConvertPixelToPoint((int)rbSp.y, false);
            mWebViewRect[3] = UniWebViewEx.ConvertPixelToPoint(Screen.width - (int)rbSp.x, true);
            //int top, int bottom, int left, int right
            //int left, int top, int right, int bottom
            SetMargins(mWebViewRect[2], mWebViewRect[0], mWebViewRect[3], mWebViewRect[1]);
        #endif
    }
