...
namespace AssetClean
{
	public class AssetCollector
	{
		...
		public void Collection (string customPath = null)
		{
			try {
				if (customPath == null)
				{
					customPath = "Assets/Game/PackagingResources";
				}
				...
				// Find assets
				var files = Directory.GetFiles (customPath, "*.*", SearchOption.AllDirectories)
				...
				UnregistReferenceFromResources(customPath);
		...
		void UnregistReferenceFromResources(string customPath )
		{
