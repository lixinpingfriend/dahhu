...
-(instancetype) init {
    ...
    if (self) {
        ...
        string1 = [NSString stringWithFormat:@"%@%@",needJump,@"ays://"];
        string2 = [NSString stringWithFormat:@"%@%@",needJump,@"ay://"];
...
-(BOOL)webView:(UniWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if ([reqUrl hasPrefix:string1] || [reqUrl hasPrefix:string2]) {
        // NOTE: 跳转支付宝App
