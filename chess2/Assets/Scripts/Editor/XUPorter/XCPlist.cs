...
namespace UnityEditor.XCodeEditor 
{
	public class XCPlist
	{
		...
		const string BundleAllowMixedLocalizations = "CFBundleAllowMixedLocalizations";
		const string PlistAllowMixedLocalizations = "AllowMixedLocalizations";
		...
		public void AddPlistItems(string key, object value, Dictionary<string, object> dict)
		{
			...
			else if(key.CompareTo(PlistAllowMixedLocalizations) == 0)
			{
				dict[BundleAllowMixedLocalizations] = (bool)value;
			}
