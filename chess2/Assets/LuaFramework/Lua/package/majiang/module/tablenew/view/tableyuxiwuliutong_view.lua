...
---@class TableYuXiWuLiuTong:TableCommonView
local TableYuXiWuLiuTong = class('tableYuXiWuLiuTong', Base)
...
function TableYuXiWuLiuTong:init_config()
...
--- 小结算时需要播放胡音效
function TableYuXiWuLiuTong:play_hu_sound_on_result()
    return false
end


function TableYuXiWuLiuTong:game_state_lai_gen(show)
...
function TableYuXiWuLiuTong:game_state_wei_zhang(show)
    show = true --self.allReady or (nil ~= self.gameState)
...
function TableYuXiWuLiuTong:game_state_end_hand(serverSeat)
...
function TableYuXiWuLiuTong:play_action_tx(action, seatInfo)
    ---@type SeatHolder2D
...
function TableYuXiWuLiuTong:game_state_dun()
