...
---@class TableLvLiangKDDController:TableCommonController
---@field view TableLvLiangKDDController
local TableLvLiangKDDController = class('tableLvLiangKDDController', Base)

--- 点击
function TableLvLiangKDDController:on_click(obj, arg)
...
--- 杠牌（长沙开杠）
function TableLvLiangKDDController:gang_mj()
...
--- 杠单个牌
function TableLvLiangKDDController:gang_one_mj(pai)
...
return TableLvLiangKDDController