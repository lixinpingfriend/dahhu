...
---@class TableFeiXiaoJiView_3d:TableCommonView
local TableFeiXiaoJiView_3d = class('tableFeiXiaoJiView_3d', Base)
...
function TableFeiXiaoJiView_3d:init_ui()
    Base.init_ui(self)
...
---癞子
function TableFeiXiaoJiView_3d:game_state_lai_zi(show)
...
---癞根
function TableFeiXiaoJiView_3d:game_state_lai_gen(show)
