...
---@class TableLvLiangKDDView_3d:Table3dCommonView
local TableLvLiangKDDView_3d = class('tableLvLiangKDDView_3d', Base)
...
--- 初始化ui
function TableLvLiangKDDView_3d:init_ui()
    Base.init_ui(self)
...
function TableLvLiangKDDView_3d:init_config()
...
function TableLvLiangKDDView_3d:get_action_tx(action)
...
---显示听牌标志
function TableLvLiangKDDView_3d:show_ting_pai_tag(localSeat, show)

end

---可胡
function TableLvLiangKDDView_3d:show_ke_hu(show)
...
---可杠 吕梁变成可补
function TableLvLiangKDDView_3d:show_ke_gang(show)
...
---长沙麻将可杠
function TableLvLiangKDDView_3d:show_ke_gang2(show)
    self.actionGang:SetActive(show)
    if(show) then
        self:show_wait_action()
    end
...
--- 隐藏操作以及弹出的操作列表
function TableLvLiangKDDView_3d:hide_wait_action_select_card()
...
--- 开始刷新gameState
function TableLvLiangKDDView_3d:game_state_begin(gameState)
...
--- 显示起手胡
function TableLvLiangKDDView_3d:show_qi_shou_hu(gameState)
    self.waitActionCS:SetActive(false)
...
--- 显示开杠之后的操作（不是自己开杠的）
function TableLvLiangKDDView_3d:show_kai_gang(gameState)
    self.csSelectKaiGang:SetActive(false)
...
--- 显示海底捞
function TableLvLiangKDDView_3d:show_hai_di_lao(show)
    self.selectHaiDi:SetActive(show)
end

--- 显示开杠详情
function TableLvLiangKDDView_3d:show_kai_gang_detail(seatId)
...
--- 设置开杠数据
function TableLvLiangKDDView_3d:set_kai_gang_data(actionObj, selectCardPanel,  pai)
...
--- 可吃 针对开杠
function TableLvLiangKDDView_3d:ke_chi_kai_gang(pai)
...
--- 开杠的牌有可操作的
function TableLvLiangKDDView_3d:have_action_kai_gang(pai,list)
...
--- 显示开杠的牌的多种操作（多吃等）
function TableLvLiangKDDView_3d:show_select_card_kai_gang(actionObj)
...
--- 牌是否亮倒
function TableLvLiangKDDView_3d:pai_is_open(playerState, handData)
    return self.curTableData.isPlayBack or (handData and handData.Pai ~= 0 and (#playerState.HuPai ~= 0 or handData.State == 2))
end

--- 牌是否扣倒
function TableLvLiangKDDView_3d:pai_is_covered(handData)
    return false
end

return TableLvLiangKDDView_3d