...
---@class TableChuXiongErWuTong_3d:Table3dCommonView
local TableChuXiongErWuTong_3d = class('tableChuXiongErWuTong_3d', Base)
...
function TableChuXiongErWuTong_3d:init_config()
    Base.init_config(self)
    self.actionSounds["4"] = {"dianpao1"}
end

function TableChuXiongErWuTong_3d:game_state_lai_gen(show)
...
function TableChuXiongErWuTong_3d:game_state_wei_zhang(show)
    show = true --self.allReady or (nil ~= self.gameState)
...
function TableChuXiongErWuTong_3d:game_state_end_hand(serverSeat)
...
function TableChuXiongErWuTong_3d:play_action_tx(action, seatInfo)
    ---@type SeatHolder3D
...
function TableChuXiongErWuTong_3d:game_state_dun()
...
return  TableChuXiongErWuTong_3d