...
ConfigChild.createRoomTable =
{
    { --襄阳
        ...
        },
        {
            ...
            {
                {
                    {disable = false,json = "\"NULL\":0",toggleType = 1,toggleTitle = "不封顶",toggleIsOn = true,},
                    {disable = false,json = "\"FengDing\":50",toggleType = 1,toggleTitle = "50分封顶",toggleIsOn = false,showType = {1,3}},
                    {disable = false,json = "\"FengDing\":100",toggleType = 1,toggleTitle = "100分封顶",toggleIsOn = false,showType = {1,3}},
                }
            }
        },
        {
            ...
            list =
            {
                ...
                {
                    {disable = false,json = "\"ZiXuanMa\":true",toggleType = 1,toggleTitle = "自选买马",toggleIsOn = false,smallShow = "6_1",smallShowType = 1,clickTip = "勾选后将手动买马"},
                    {disable = false,json = "\"ZiXuanMa\":false",toggleType = 1,toggleTitle = "系统自动买马",toggleIsOn = true,smallShow = "6_1",smallShowType = 1,clickSmallShow = "7_1",clickTip = "勾选后系统自动买马"},
                    {disable = false,json = "\"MaiYiZengYi\":true",toggleType = 2,toggleTitle = "买一赠一",toggleIsOn = false,smallShow = "7_1",smallShowType = 1},
                },
            }
        },
        {
        ...
        layout3dTypes = { 1,2 }, ---游戏内可使用的3D麻将布局,如果不设置，则默认为Type1布局
        NoPreTabel = true,  ---关闭小结算回看牌桌功能
