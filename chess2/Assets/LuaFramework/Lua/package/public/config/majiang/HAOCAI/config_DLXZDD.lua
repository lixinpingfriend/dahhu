...
ConfigChild.createRoomTable =
{
    { --大理血战
            ...
            {
                {
                    ...
                    {disable = false,json = "\"roundCount\":12",toggleType = 1,toggleTitle = "12局",addJson = "\"isDoubleQuan\":false",toggleIsOn = false},
        ...
        {
            tag = {togglesTile = "点杠:",rowNum = 3},
            list =
            {
                {
                    {disable = false,json = "\"DianGangHua\":true",toggleType = 1,toggleTitle = "点杠花算点炮",toggleIsOn = true},
                    {disable = false,json = "\"DianGangHua\":false",toggleType = 1,toggleTitle = "点杠花算自摸",toggleIsOn = false},
                }
            }
        },
        {
            ...
            {
                {
                    {disable = false,json = "\"HuanSanZhang\":true",toggleType = 2,toggleTitle = "换三张",toggleIsOn = false},
                    {disable = false,json = "\"MenQingZhongZhang\":true",toggleType = 2,toggleTitle = "门清中张",toggleIsOn = false},
                    {disable = false,json = "\"TianDiHu\":true",toggleType = 2,toggleTitle = "天地胡",toggleIsOn = false},
                    {disable = false,json = "\"DaiYaoJiuJiang\":true",toggleType = 2,toggleTitle = "带幺九将对",toggleIsOn = false},
                    {disable = false,json = "\"HuJiaoZhuanYi\":1",toggleType = 2,toggleTitle = "呼叫转移",toggleIsOn = false},
            ...
            {
                {
                    ...
                    {disable = false,json = "\"PayType\":2",toggleType = 1,toggleTitle = "大赢家支付",toggleIsOn = true},
                },
            }
        },
