...
ConfigChild.createRoomTable =
{
    { --红中
        ...
        { 
            ...
            {
                {
                    {disable = false,json = "\"YouLaiZi\":true",toggleType = 2,toggleTitle = "红中",toggleIsOn = true},
                    ...
                    {disable = false,json = "\"YouQiangGangHu\":true",toggleType = 2,toggleTitle = "抢杠胡",toggleIsOn = true,clickSmallShow="1_1"},
                    {disable = false,json = "\"QiangGangWuHongZhong\":true",toggleType = 2,toggleTitle = "抢杠无红中",toggleIsOn = false,smallShow= "1_1",smallShowType = 1},
                }
            }
        },
        { 
