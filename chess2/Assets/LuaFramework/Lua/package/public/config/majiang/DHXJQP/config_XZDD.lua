    ...
    { --血战到底
        ...
        },
        {
            ...
            list =
            {
                ...
                {
                    {disable = false,json = "\"ZiMoType\":1",toggleType = 1,toggleTitle = "加底",toggleIsOn = false,},
                    {disable = false,json = "\"ZiMoType\":2",toggleType = 1,toggleTitle = "加番",toggleIsOn = false,},
                    {disable = false,json = "\"ZiMoType\":0",toggleType = 1,toggleTitle = "不加底不加番",toggleIsOn = true,},
                },
            }
        },
        {
