...
ConfigChild.createRoomTable =
{
    { --玉溪飞小鸡
        ...
        },
        {
            ...
            {
                {
                    {disable = false,json = "\"XiaoJiFei\":1",toggleType = 1,toggleTitle = "超级小鸡飞",toggleIsOn = true},
                    {disable = false,json = "\"XiaoJiFei\":2",toggleType = 1,toggleTitle = "小鸡飞",toggleIsOn = false},
                },
                {
                    {disable = false,json = "\"BaoPao\":true",toggleType = 2,toggleTitle = "包炮",toggleIsOn = true,clickTip = "点杠花翻倍"},
...
ConfigChild.HowToPlayTexts =
{
    ...
    10) 幺鸡（1条）为固定赖子，可以当做任何牌来使用，不能打出去
    11) 小鸡可组杠，最多可3个小鸡加1张其他牌杠牌
     </size>
