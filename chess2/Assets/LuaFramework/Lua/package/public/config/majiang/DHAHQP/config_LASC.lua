...
ConfigChild.createRoomTable =
{
    { --舒城
        ...
        },
        {
            ...
            {
                {
                    {disable = false,json = "\"GangKaiBeiShu\":2",toggleType = 1,toggleTitle = "杠开2、4、6倍",toggleIsOn = false},
                    {disable = false,json = "\"GangKaiBeiShu\":4",toggleType = 1,toggleTitle = "杠开4、8、12倍",toggleIsOn = true},
                }
            }
        },
        {
