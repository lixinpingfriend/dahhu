...
ConfigChild.createRoomTable =
{
    ...
    { --单将长牌
        ...
        {
            tag = {togglesTile = "塌子胡:",rowNum = 3},
            list =
            {
                {
                    {disable = false,json = "\"TaZiHu\":20",toggleType = 1,toggleTitle = "20胡",toggleIsOn = true},
                    {disable = false,json = "\"TaZiHu\":30",toggleType = 1,toggleTitle = "30胡",toggleIsOn = false},
                }
            }
        },
        {
...
3）可以接炮胡，也可以自摸胡牌;
4）坐庄:第一局由房主坐庄，之后无论谁胡都是轮庄，即庄家下家坐庄;
5）老将:红花、千字、白花这四种牌统称为老将;
6）头尾将:所有1和9的牌都算头尾将;
7) 跟随将:
   ◆ 翻将是147的牌，则其余147的牌算作跟随将;
   ◆ 翻将是258的牌，则其余258的牌算作跟随将;
   ◆ 翻将是369的牌，则其余369的牌算作跟随将;
   ◆ 翻将是喜牌，则其余147的牌算作跟随将;
   ◆ 翻将是千字的牌，则其余147的牌算作跟随将;
   ◆ 翻将是红花的牌，则其余258的牌算作跟随将;
   ◆ 翻将是白花的牌，则其余369的牌算作跟随将;
8）出分:无论有无胡牌，三个玩家都要依次与另外两个玩家结算;
</size>
<size=32><color=#004f3c>三.底分算胡</color></size>
<size=28>
1）刻名次解释:三张算作碰，三张在手算暗刻，碰三张算明刻;
2）杠名次解释:四张算作杠，自己摸四张算暗杠，接别人的算明杠，起手
   四张算撂龙;
3）翻将是普通牌时:
   ◆ 普通牌在将上:碰8胡，暗刻24胡，撂龙32胡;
   ◆ 普通牌不在将上:碰1胡，暗刻2胡，明杠4胡，暗杠6胡，撂龙8胡;
   ◆ 老将算胡:碰4胡，暗刻8胡，明杠12胡，暗杠24胡，撂龙32胡;
5）翻将是老将时;
   ◆ 老将在将上:碰16胡，暗刻48胡，撂龙64胡;
   ◆ 老将不在将上:碰8胡，暗刻16胡，明杠32胡，暗杠48胡，撂龙64胡;
6）头尾将、跟随将算胡:
   ◆ 碰4胡，暗刻8胡，明杠16胡，暗杠24胡，撂龙32胡;
</size>
<size=32><color=#004f3c>四.特殊算胡</color></size>
<size=28>
1）文钱:牌型中每出现一个123筒，称为一个文钱;
...
5）软独钓:
   ...
   ◆ 接炮:10胡;
6）三老会面:所有胡数x2
7）天胡:所有算胡x2，庄家起手自摸胡牌称为天胡;
8）天听:所有算胡x2，起手听牌称为天听，天听后不可改听，在此
   基础上允许胡、杠;
9）穷狠:所有算胡x2，创建房间时选择有喜牌，但胡牌玩家没有喜牌;
10）穷穷狠:所有算胡x4，创建房间时选择有喜，翻将是喜牌，但结算时.
    自己的牌没有喜牌;
11）双龙:所有算胡x2;有两个暗杠或者撂龙;
12) 海底捞月:所有算胡x2;最后一张牌自摸;
</size>
<size=32><color=#004f3c>五.喜牌算胡</color></size>
<size=28>
1）翻将不是喜牌时，按玩家手里的喜牌数量算胡;
   ◆ 1个:10胡;
   ◆ 2个:30胡;
   ◆ 3个:50胡;
   ◆ 4个:100胡;
   ◆ 5个:200胡;
2）翻将是喜牌时，玩家手中的喜牌胡数翻倍;
   ◆ 起手4个喜牌：400胡;
</size>
<size=32><color=#004f3c>六.牌型算胡</color></size>
<size=28>
...
2）清胡:胡牌时，牌型有7个顺子加一个对子组成;
3）塌子胡:胡牌时，由顺子、刻子/杠以及一个对子组成;
4）闷飘:胡牌时，全部在手的飘胡（可以有明杠、暗杠和撂龙）;
5）十三胡:手中牌型同清胡一样，可以有一个不当将牌的碰;
</size>]]
}
