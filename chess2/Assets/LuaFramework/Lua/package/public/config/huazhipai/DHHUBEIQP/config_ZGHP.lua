    ...
    { --秭归上大人
		...
		},
        {
            ...
            list =
            {
				...
				{
					{disable = false,json = "\"ChaRuanYing\":2",toggleType = 1,toggleTitle = "查硬听",toggleIsOn = true},
					{disable = false,json = "\"ChaRuanYing\":1",toggleType = 1,toggleTitle = "查软听",toggleIsOn = false},
					{disable = false,json = "\"ChaRuanYing\":0",toggleType = 1,toggleTitle = "不查听",toggleIsOn = false},
				},
				{
					...
					{ disable = false, json = "\"ZuiDiHu\":21", toggleType = 2, toggleTitle = "二十一胡", toggleIsOn = false,},
					{ disable = false, json = "\"TieMaoJiaFen\":1", toggleType = 2, toggleTitle = "贴毛加分", toggleIsOn = false,},
