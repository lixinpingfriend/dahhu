		...
		},
        {
            ...
            list =
            {
				...
				},
				{
					...
					--{ disable = false, json = "\"BaoChong\":true", toggleType = 2, toggleTitle = "包铳(双倍计分)", clickSmallShow="2_2", toggleIsOn = false,},
					--{ disable = false, json = "\"BaoChongType\":1", toggleType = 2, toggleTitle = "包铳(不包毛坎)", smallShowType = 1,smallShow="2_2", toggleIsOn = false,},
				},
            }
		},
		{
            tag = {togglesTile = "包铳:",rowNum = 3},
            list =
            {
                {
					{ disable = false, json = "\"BaoChongType\":0", toggleType = 1, toggleTitle = "不包铳",  toggleIsOn = true,},
                    { disable = false, json = "\"BaoChongType\":2", toggleType = 1, toggleTitle = "包铳(双倍计分)",  toggleIsOn = false,},
					{ disable = false, json = "\"BaoChongType\":1", toggleType = 1, toggleTitle = "包铳(不包毛坎)",  toggleIsOn = false,},
				}
			},
		},
        {
