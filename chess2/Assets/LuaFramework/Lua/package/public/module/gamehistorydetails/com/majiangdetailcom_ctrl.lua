...
---@class MaJiangDetailComCtrl:DetailComCtrlBase
---@field comView MaJiangDetailComView 
local MaJiangDetailComCtrl = Class("maJiangDetailComCtrl",Base)

local TableManager = TableManager
local ModuleCache = ModuleCache

function MaJiangDetailComCtrl:on_Init()

end

function MaJiangDetailComCtrl:on_show(roomDetailsInfo)
...
function MaJiangDetailComCtrl:sort_roomDetailsInfo(roomDetailsInfo)
...
function MaJiangDetailComCtrl:on_destroy()
    
end

function MaJiangDetailComCtrl:on_click(obj, arg)
