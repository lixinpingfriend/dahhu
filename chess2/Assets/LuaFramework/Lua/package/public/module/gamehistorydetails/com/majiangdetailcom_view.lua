...
---@class MaJiangDetailComView:DetailComViewBase
local MaJiangDetailComView = Class("maJiangDetailComView",Base)
...
function MaJiangDetailComView:on_Init(comViewRoot)
...
function MaJiangDetailComView:on_destroy()
    
end

function MaJiangDetailComView:refresh_player_info(roomDetailsInfo)
...
function MaJiangDetailComView:refresh_history_list(roomDetailsInfo)
...
function MaJiangDetailComView:clear_history_list()
...
function MaJiangDetailComView:init_history_item(gameObject)
	local historyItem = {}
...
function MaJiangDetailComView:RegisterHistoryItemEvent(historyItem)
    ...
    historyItem.playBackBtn.onClick:AddListener(function()
        ...
        ModuleCache.GameManager.change_game_by_gameName(roundInfo.gameName)
        TableManager:play_back(data,players,true,playBackInitData,nil,function ()
