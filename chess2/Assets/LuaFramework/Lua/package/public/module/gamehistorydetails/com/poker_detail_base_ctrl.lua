...
---@class PokerDetailComCtrl:DetailComCtrlBase
---@field comView PokerDetailComView
local PokerDetailComCtrl = Class("PokerDetailComCtrl",Base)

local TableManager = TableManager
local ModuleCache = ModuleCache

function PokerDetailComCtrl:on_Init()

end

function PokerDetailComCtrl:on_show(roomDetailsInfo)
...
function PokerDetailComCtrl:sort_roomDetailsInfo(roomDetailsInfo)
...
function PokerDetailComCtrl:on_destroy()
    
end

function PokerDetailComCtrl:on_click(obj, arg)
