...
public class QPYX_ComponentCache_Injection_SpriteHolderWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(ComponentCache.Injection<SpriteHolder>), typeof(System.Object), "Injection_SpriteHolder");
		L_YXQP.RegFunction("New", QPYX__CreateComponentCache_Injection_SpriteHolder_YXQP);
	...
	static int QPYX__CreateComponentCache_Injection_SpriteHolder_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			{
				ComponentCache.Injection<SpriteHolder> QPYX_obj_YXQP = new ComponentCache.Injection<SpriteHolder>();
				ToLua.PushObject(L_YXQP, QPYX_obj_YXQP);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L_YXQP, "invalid arguments to ctor method: ComponentCache.Injection<SpriteHolder>.New");
			}
		}
