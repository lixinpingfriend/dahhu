...
public class QPYX_ComponentCache_Injection_ComponentCacheWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(ComponentCache.Injection<ComponentCache>), typeof(System.Object), "Injection_ComponentCache");
		L_YXQP.RegFunction("New", QPYX__CreateComponentCache_Injection_ComponentCache_YXQP);
	...
	static int QPYX__CreateComponentCache_Injection_ComponentCache_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			{
				ComponentCache.Injection<ComponentCache> QPYX_obj_YXQP = new ComponentCache.Injection<ComponentCache>();
				ToLua.PushObject(L_YXQP, QPYX_obj_YXQP);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L_YXQP, "invalid arguments to ctor method: ComponentCache.Injection<ComponentCache>.New");
			}
		}
