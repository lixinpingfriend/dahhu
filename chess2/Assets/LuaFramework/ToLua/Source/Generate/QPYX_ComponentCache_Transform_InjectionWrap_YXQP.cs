...
public class QPYX_ComponentCache_Transform_InjectionWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(ComponentCache.Transform_Injection), typeof(ComponentCache.Injection<UnityEngine.Transform>));
		L_YXQP.RegFunction("New", QPYX__CreateComponentCache_Transform_Injection_YXQP);
