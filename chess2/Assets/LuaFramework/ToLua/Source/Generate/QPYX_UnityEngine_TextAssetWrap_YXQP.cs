...
public class QPYX_UnityEngine_TextAssetWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(UnityEngine.TextAsset), typeof(UnityEngine.Object));
		L_YXQP.RegFunction("ToString", QPYX_ToString_YXQP);
		L_YXQP.RegFunction("New", QPYX__CreateUnityEngine_TextAsset_YXQP);
		L_YXQP.RegFunction("__eq", QPYX_op_Equality_YXQP);		L_YXQP.RegFunction("__tostring", ToLua.op_ToString);		L_YXQP.RegVar("text", QPYX_get_text_YXQP, null);
	...
	static int QPYX_ToString_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			UnityEngine.TextAsset  QPYX_obj_YXQP  = (UnityEngine.TextAsset)ToLua.CheckObject<UnityEngine.TextAsset>(L_YXQP, 1);
	...
	static int QPYX_get_text_YXQP(IntPtr L_YXQP)
	{
		...
		try
		{
			QPYX_o_YXQP = ToLua.ToObject(L_YXQP, 1);			UnityEngine.TextAsset QPYX_obj_YXQP = (UnityEngine.TextAsset)QPYX_o_YXQP;
