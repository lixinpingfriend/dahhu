...
public class QPYX_TweenerCoreV3V3VOWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions>), typeof(DG.Tweening.Tweener), "TweenerCoreV3V3VO");
	...
	static int QPYX_ChangeStartValue_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L_YXQP, "invalid arguments to method: DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions>.ChangeStartValue");
			}
		}
	...
	static int QPYX_ChangeValues_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L_YXQP, "invalid arguments to method: DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions>.ChangeValues");
			}
		}
		catch (Exception e_YXQP)		{
			return LuaDLL.toluaL_exception(L_YXQP, e_YXQP);		}
	...
	static int QPYX_get_plugOptions_YXQP(IntPtr L_YXQP)
	{
		...
		{
			QPYX_o_YXQP = ToLua.ToObject(L_YXQP, 1);			DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions> QPYX_obj_YXQP = (DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions>)QPYX_o_YXQP;
			DG.Tweening.Plugins.Options.VectorOptions QPYX_ret_YXQP = QPYX_obj_YXQP.plugOptions;
