...
public class QPYX_ComponentCache_Injection_UIImageAnimationWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(ComponentCache.Injection<UIImageAnimation>), typeof(System.Object), "Injection_UIImageAnimation");
		L_YXQP.RegFunction("New", QPYX__CreateComponentCache_Injection_UIImageAnimation_YXQP);
	...
	static int QPYX__CreateComponentCache_Injection_UIImageAnimation_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			{
				ComponentCache.Injection<UIImageAnimation> QPYX_obj_YXQP = new ComponentCache.Injection<UIImageAnimation>();
				ToLua.PushObject(L_YXQP, QPYX_obj_YXQP);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L_YXQP, "invalid arguments to ctor method: ComponentCache.Injection<UIImageAnimation>.New");
			}
		}
