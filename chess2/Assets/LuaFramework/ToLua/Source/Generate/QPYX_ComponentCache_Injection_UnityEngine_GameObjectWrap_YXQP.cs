...
public class QPYX_ComponentCache_Injection_UnityEngine_GameObjectWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(ComponentCache.Injection<UnityEngine.GameObject>), typeof(System.Object), "Injection_UnityEngine_GameObject");
		L_YXQP.RegFunction("New", QPYX__CreateComponentCache_Injection_UnityEngine_GameObject_YXQP);
	...
	static int QPYX__CreateComponentCache_Injection_UnityEngine_GameObject_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			{
				ComponentCache.Injection<UnityEngine.GameObject> QPYX_obj_YXQP = new ComponentCache.Injection<UnityEngine.GameObject>();
				ToLua.PushObject(L_YXQP, QPYX_obj_YXQP);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L_YXQP, "invalid arguments to ctor method: ComponentCache.Injection<UnityEngine.GameObject>.New");
			}
		}
	...
	static int QPYX_get_name_YXQP(IntPtr L_YXQP)
	{
		...
		try
		{
			QPYX_o_YXQP = ToLua.ToObject(L_YXQP, 1);			ComponentCache.Injection<UnityEngine.GameObject> QPYX_obj_YXQP = (ComponentCache.Injection<UnityEngine.GameObject>)QPYX_o_YXQP;
	...
	static int QPYX_get_value_YXQP(IntPtr L_YXQP)
	{
		...
		{
			QPYX_o_YXQP = ToLua.ToObject(L_YXQP, 1);			ComponentCache.Injection<UnityEngine.GameObject> QPYX_obj_YXQP = (ComponentCache.Injection<UnityEngine.GameObject>)QPYX_o_YXQP;
			UnityEngine.GameObject QPYX_ret_YXQP = QPYX_obj_YXQP.value;
