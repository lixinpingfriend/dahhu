...
public class QPYX_UnityEngine_UI_Dropdown_DropdownEventWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(UnityEngine.UI.Dropdown.DropdownEvent), typeof(UnityEngine.Events.UnityEvent<int>));
		L_YXQP.RegFunction("New", QPYX__CreateUnityEngine_UI_Dropdown_DropdownEvent_YXQP);
