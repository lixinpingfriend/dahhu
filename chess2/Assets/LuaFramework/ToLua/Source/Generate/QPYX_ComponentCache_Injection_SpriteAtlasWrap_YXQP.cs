...
public class QPYX_ComponentCache_Injection_SpriteAtlasWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(ComponentCache.Injection<SpriteAtlas>), typeof(System.Object), "Injection_SpriteAtlas");
		L_YXQP.RegFunction("New", QPYX__CreateComponentCache_Injection_SpriteAtlas_YXQP);
	...
	static int QPYX__CreateComponentCache_Injection_SpriteAtlas_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			{
				ComponentCache.Injection<SpriteAtlas> QPYX_obj_YXQP = new ComponentCache.Injection<SpriteAtlas>();
				ToLua.PushObject(L_YXQP, QPYX_obj_YXQP);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L_YXQP, "invalid arguments to ctor method: ComponentCache.Injection<SpriteAtlas>.New");
			}
		}
	...
	static int QPYX_get_name_YXQP(IntPtr L_YXQP)
	{
		...
		try
		{
			QPYX_o_YXQP = ToLua.ToObject(L_YXQP, 1);			ComponentCache.Injection<SpriteAtlas> QPYX_obj_YXQP = (ComponentCache.Injection<SpriteAtlas>)QPYX_o_YXQP;
	...
	static int QPYX_get_value_YXQP(IntPtr L_YXQP)
	{
		...
		{
			QPYX_o_YXQP = ToLua.ToObject(L_YXQP, 1);			ComponentCache.Injection<SpriteAtlas> QPYX_obj_YXQP = (ComponentCache.Injection<SpriteAtlas>)QPYX_o_YXQP;
			SpriteAtlas QPYX_ret_YXQP = QPYX_obj_YXQP.value;
