...
public class QPYX_UnityEngine_UI_ScrollRect_ScrollRectEventWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(UnityEngine.UI.ScrollRect.ScrollRectEvent), typeof(UnityEngine.Events.UnityEvent<UnityEngine.Vector2>));
		L_YXQP.RegFunction("New", QPYX__CreateUnityEngine_UI_ScrollRect_ScrollRectEvent_YXQP);
