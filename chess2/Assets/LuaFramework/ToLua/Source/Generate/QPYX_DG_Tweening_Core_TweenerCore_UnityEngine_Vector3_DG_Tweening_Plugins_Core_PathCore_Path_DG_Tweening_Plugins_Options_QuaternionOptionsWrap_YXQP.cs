...
public class QPYX_DG_Tweening_Core_TweenerCore_UnityEngine_Vector3_DG_Tweening_Plugins_Core_PathCore_Path_DG_Tweening_Plugins_Options_QuaternionOptionsWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.QuaternionOptions>), typeof(DG.Tweening.Tweener), "TweenerCore_UnityEngine_Vector3_DG_Tweening_Plugins_Core_PathCore_Path_DG_Tweening_Plugins_Options_QuaternionOptions");
	...
	static int QPYX_ChangeStartValue_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			{
				DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.QuaternionOptions>  QPYX_obj_YXQP  = (DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.QuaternionOptions>)ToLua.CheckObject<DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.QuaternionOptions>>(L_YXQP, 1);
			...
			{
				return LuaDLL.luaL_throw(L_YXQP, "invalid arguments to method: DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.QuaternionOptions>.ChangeStartValue");
			}
		}
	...
	static int QPYX_ChangeEndValue_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L_YXQP, "invalid arguments to method: DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.QuaternionOptions>.ChangeEndValue");
			}
		}
		catch (Exception e_YXQP)		{
			return LuaDLL.toluaL_exception(L_YXQP, e_YXQP);		}
	...
	static int QPYX_ChangeValues_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L_YXQP, "invalid arguments to method: DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.QuaternionOptions>.ChangeValues");
			}
		}
		catch (Exception e_YXQP)		{
			return LuaDLL.toluaL_exception(L_YXQP, e_YXQP);		}
	...
	static int QPYX_get_startValue_YXQP(IntPtr L_YXQP)
	{
		...
		try
		{
			...
			DG.Tweening.Plugins.Core.PathCore.Path QPYX_ret_YXQP = QPYX_obj_YXQP.startValue;
	...
	static int QPYX_get_changeValue_YXQP(IntPtr L_YXQP)
	{
		...
		{
			QPYX_o_YXQP = ToLua.ToObject(L_YXQP, 1);			DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.QuaternionOptions> QPYX_obj_YXQP = (DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.QuaternionOptions>)QPYX_o_YXQP;
			DG.Tweening.Plugins.Core.PathCore.Path QPYX_ret_YXQP = QPYX_obj_YXQP.changeValue;
			ToLua.PushObject(L_YXQP, QPYX_ret_YXQP);
			return 1;
		}
		catch(Exception QPYX_e_YXQP)		{
	...
	static int QPYX_get_plugOptions_YXQP(IntPtr L_YXQP)
	{
		...
		{
			QPYX_o_YXQP = ToLua.ToObject(L_YXQP, 1);			DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.QuaternionOptions> QPYX_obj_YXQP = (DG.Tweening.Core.TweenerCore<UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.QuaternionOptions>)QPYX_o_YXQP;
			DG.Tweening.Plugins.Options.QuaternionOptions QPYX_ret_YXQP = QPYX_obj_YXQP.plugOptions;
