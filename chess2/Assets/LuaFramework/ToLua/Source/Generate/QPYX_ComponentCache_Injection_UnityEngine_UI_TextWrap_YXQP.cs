...
public class QPYX_ComponentCache_Injection_UnityEngine_UI_TextWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(ComponentCache.Injection<UnityEngine.UI.Text>), typeof(System.Object), "Injection_UnityEngine_UI_Text");
		L_YXQP.RegFunction("New", QPYX__CreateComponentCache_Injection_UnityEngine_UI_Text_YXQP);
	...
	static int QPYX__CreateComponentCache_Injection_UnityEngine_UI_Text_YXQP(IntPtr L_YXQP)
	{
		try
		{
			...
			{
				ComponentCache.Injection<UnityEngine.UI.Text> QPYX_obj_YXQP = new ComponentCache.Injection<UnityEngine.UI.Text>();
				ToLua.PushObject(L_YXQP, QPYX_obj_YXQP);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L_YXQP, "invalid arguments to ctor method: ComponentCache.Injection<UnityEngine.UI.Text>.New");
			}
		}
	...
	static int QPYX_get_name_YXQP(IntPtr L_YXQP)
	{
		...
		try
		{
			QPYX_o_YXQP = ToLua.ToObject(L_YXQP, 1);			ComponentCache.Injection<UnityEngine.UI.Text> QPYX_obj_YXQP = (ComponentCache.Injection<UnityEngine.UI.Text>)QPYX_o_YXQP;
	...
	static int QPYX_get_value_YXQP(IntPtr L_YXQP)
	{
		...
		{
			QPYX_o_YXQP = ToLua.ToObject(L_YXQP, 1);			ComponentCache.Injection<UnityEngine.UI.Text> QPYX_obj_YXQP = (ComponentCache.Injection<UnityEngine.UI.Text>)QPYX_o_YXQP;
			UnityEngine.UI.Text QPYX_ret_YXQP = QPYX_obj_YXQP.value;
