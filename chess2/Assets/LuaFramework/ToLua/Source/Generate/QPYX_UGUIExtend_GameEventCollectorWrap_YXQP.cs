...
public class QPYX_UGUIExtend_GameEventCollectorWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(UGUIExtend.GameEventCollector), typeof(UnityEngine.MonoBehaviour));
		L_YXQP.RegFunction("__eq", QPYX_op_Equality_YXQP);		L_YXQP.RegFunction("__tostring", ToLua.op_ToString);		L_YXQP.RegVar("packageName", QPYX_get_packageName_YXQP, QPYX_set_packageName_YXQP);
	...
	static int QPYX_get_packageName_YXQP(IntPtr L_YXQP)
	{
		...
		try
		{
			QPYX_o_YXQP = ToLua.ToObject(L_YXQP, 1);			UGUIExtend.GameEventCollector QPYX_obj_YXQP = (UGUIExtend.GameEventCollector)QPYX_o_YXQP;
