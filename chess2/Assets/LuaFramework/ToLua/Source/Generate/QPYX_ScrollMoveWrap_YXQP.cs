...
public class QPYX_ScrollMoveWrap_YXQP
{
	public static void QPYX_Register_YXQP(LuaState L_YXQP)	{
		L_YXQP.BeginClass(typeof(ScrollMove), typeof(UnityEngine.EventSystems.UIBehaviour));
		...
		L_YXQP.RegFunction("__eq", QPYX_op_Equality_YXQP);		L_YXQP.RegFunction("__tostring", ToLua.op_ToString);		L_YXQP.RegVar("m_Inertia", QPYX_get_m_Inertia_YXQP, QPYX_set_m_Inertia_YXQP);
